...
|------------------|------------------|------------------|
| [<img src="https://github.com/SamDevFocus/Sapient-Dino/blob/main/Home.png?raw=true" width="280" alt="Home do SapientDino">](https://github.com/SamDevFocus/Sapient-Dino) | [<img src="https://github.com/SamDevFocus/Sapient-Dino/blob/main/Biblioteca.png?raw=true" width="280" alt="Biblioteca IA">](https://github.com/SamDevFocus/Sapient-Dino) | [<img src="https://github.com/SamDevFocus/Sapient-Dino/blob/main/Chat.png?raw=true" width="280" alt="Chat com IA">](https://github.com/SamDevFocus/Sapient-Dino) |
</div>
...
| <img src="https://github.com/NOME_USUARIO_AQUI.png" width="80" style="border-radius:50%"> <br> **Vitor Daniel Dorea Santos** <br> 📍 Desenvolvedor e estudante de Análise e Desenvolvimento de Sistemas <br> 💬 Entusiasta em tecnologia, sempre buscando novas formas de inovar e colaborar em equipe. | [github.com/Vitorddorea](https://github.com/Vitorddorea) |
| <img src="https://github.com/NOME_USUARIO_AQUI.png" width="80" style="border-radius:50%"> <br> **John Lucas Garcia dos Santos** <br> 📍 Desenvolvedor e estudante de Análise e Desenvolvimento de Sistemas <br> 💬 Entusiasta em tecnologia, sempre buscando novas formas de inovar e colaborar em equipe. | [github.com/kbeca-ads](https://github.com/kbeca-ads) |
| <img src="https://github.com/NOME_USUARIO_AQUI.png" width="80" style="border-radius:50%"> <br> **Jéssica Tais da Silva** <br> 📍 Desenvolvedor e estudante de Análise e Desenvolvimento de Sistemas <br> 💬 Entusiasta em tecnologia, sempre buscando novas formas de inovar e colaborar em equipe. | [github.com/jessyx934](https://github.com/jessyx934) |
